...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/dashblack-cli.cpp \
           src/dashblack-tx.cpp \
           src/dashblack.cpp \
           src/db.cpp \
           ...
           src/qt/dashblack.cpp \
           src/qt/dashblackstrings.cpp \
...
RESOURCES += src/qt/dashblack.qrc src/qt/dashblack_locale.qrc

TRANSLATIONS += src/qt/locale/dashblack_bg.ts \
                src/qt/locale/dashblack_de.ts \
                src/qt/locale/dashblack_en.ts \
                src/qt/locale/dashblack_es.ts \
                src/qt/locale/dashblack_fi.ts \
                src/qt/locale/dashblack_fr.ts \
                src/qt/locale/dashblack_it.ts \
                src/qt/locale/dashblack_ja.ts \
                src/qt/locale/dashblack_pl.ts \
                src/qt/locale/dashblack_pt.ts \
                src/qt/locale/dashblack_ru.ts \
                src/qt/locale/dashblack_sk.ts \
                src/qt/locale/dashblack_sv.ts \
                src/qt/locale/dashblack_vi.ts \
                src/qt/locale/dashblack_zh_CN.ts \
                src/qt/locale/dashblack_zh_TW.ts

...
In order to support loading of multiple wallets in dashblack-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dashblack.cpp.
...
Changes to dashblack.cpp
----------------------
dashblack.cpp is the entry point into dashblack-qt, and as such, will require some minor modifications to provide hooks for

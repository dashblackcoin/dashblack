...
Dash Black now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<dashblack_address\> \<monthly_payment_dashblack\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DASHB, _12_ times over the course of a year totaling _24000_ DASHB.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<dashblack_address\> \<monthly_payment_dashblack\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` DASHB.
 ...
 * vote-many          - Vote on a Dash Black initiative
 * vote-alias         - Vote on a Dash Black initiative
 * vote               - Vote on a Dash Black initiative/budget

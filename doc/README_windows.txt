...
Intro
-----
Dash Black (DASHB) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Dash Black utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run dashblack-qt.exe.

Dash Black Core is the original Dash Black client and it builds the backbone of the network.
However, it downloads and stores the entire history of Dash Black transactions;

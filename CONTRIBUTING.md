Contributing to Dash Black Core
==================================

The Dash Black Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dash Black Core project, and is not to be
confused with overall Dash Black Network Protocol consensus changes.

Whether a pull request is merged into Dash Black Core rests with the project merge
...
Patches that change Dash Black consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dash Black consensus, it must have been
...
The project leader is the release manager for each Dash Black Core release.

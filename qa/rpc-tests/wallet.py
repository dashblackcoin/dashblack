...
#   c) node1 mines 32 blocks, so now node 0 has 500000DASHB, node 1 has 4250DASHB, node2 has none.
#   d) node0 sends 601 DASHB to node2, in two transactions (301 DASHB, then 300 DASHB).

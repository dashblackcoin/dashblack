...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dash Black Core dashblack-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dashblack-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dashb coin transaction") + "\n" +
                               "  dashblack-tx [options] -create [commands]   " + _("Create hex-encoded dashb coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dashb coin transaction

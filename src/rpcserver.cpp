...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 30000000000.0)
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Dash Black server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Dash Black server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dash Black features */
        {"dashblack", "masternode", &masternode, true, true, false},
        {"dashblack", "listmasternodes", &listmasternodes, true, true, false},
        {"dashblack", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dashblack", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dashblack", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dashblack", "masternodedebug", &masternodedebug, true, true, false},
        {"dashblack", "startmasternode", &startmasternode, true, true, false},
        {"dashblack", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dashblack", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dashblack", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dashblack", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dashblack", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dashblack", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dashblack", "mnbudget", &mnbudget, true, true, false},
        {"dashblack", "preparebudget", &preparebudget, true, true, false},
        {"dashblack", "submitbudget", &submitbudget, true, true, false},
        {"dashblack", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dashblack", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dashblack", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dashblack", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dashblack", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dashblack", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dashblack", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dashblack", "checkbudgets", &checkbudgets, true, true, false},
        {"dashblack", "mnsync", &mnsync, true, true, false},
        {"dashblack", "spork", &spork, true, true, false},
        {"dashblack", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"dashblack", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"dashblack", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"dashblack", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"dashblack", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"dashblack", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> dashblack-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9747/\n";
}

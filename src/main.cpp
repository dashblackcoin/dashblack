...
#if defined(NDEBUG)
#error "Dash Black cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in udashb) are considered zero fee (for relaying and mining)
...
{
    RenameThread("dashblack-scriptch");

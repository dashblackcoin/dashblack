...
/* Dash Black GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DashBlack"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "DashBlack-Qt"
#define QAPP_APP_NAME_TESTNET "DashBlack-Qt-testnet"

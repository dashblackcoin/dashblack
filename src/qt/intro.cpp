...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dash Black Core"),
     ...
     * override -datadir in the dashblack.conf file in the default data directory
     * (to be consistent with dashblackd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

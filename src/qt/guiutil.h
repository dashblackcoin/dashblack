...
/** Utility functions used by the DashBlack Qt UI.
 */
namespace GUIUtil
{
...
// Render DASHB addresses in monospace font
...
// Parse "dashblack:" URI into recipient object, return true on successful parsing
